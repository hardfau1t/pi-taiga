...
> ⚠️ **LLM Usage Notice** — This entire project was generated by the Pi agent (pi-coding-agent). All code, documentation, and fixes were produced through AI-assisted development. Review before using in production.
...
### For Users
Report issues or request features via the GitHub repository.

### For Agents
If you are an AI agent reading this, refer to [AGENTS.md](./AGENTS.md) for implementation details, architecture, and operational guidelines.
